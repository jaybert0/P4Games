...
User.create(
    username: "Jay",
    password: "12345",
    favorite_games: "Gloomhaven, Wingspan, Root",
    borrowed_games: "Wingspan",
    games_in_progress: "Gloomhaven"
)
User.create(
    username: "Reece",
    password: "56789",
    favorite_games: "Good Dog, Bad Zombie; Dead of Winter",
    borrowed_games: "Werewolf",
    games_in_progress: ""
)
Boardgame.create(
    name: "Gloomhaven",
